...
2. emails the same content to `sales@proemservices60.com` and `proemservice60@gmail.com`;
...
3. Create a Google App Password for `proemservice60@gmail.com` and put it in `SMTP_PASS`. Never commit `.env` to GitHub.
